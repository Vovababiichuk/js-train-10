...
function customAssign(...objects) {
   ...
   const concat = Object.assign(...objects);

   for (let key in concat) {
      if (typeof concat[key] === 'number') {
         concat[key] = concat[key].toString();
      }
   }
...
function extendAndFreezeObject(obj1, obj2) {
   ...
   if (Object.isFrozen(obj1)) {
      ...
      return 'Error: Object could not be frozen';
   }
}
...
console.log(filterObjectsByKey([{ a: 1, b: 2 }, { a: 3, b: 4 }, { a: 5 }], 'b')); // Виведе [{a: 1, b: 2}, {a: 3, b: 4}]
